...
// Test data factories with unique IDs
let mockIdCounter = 0;
const createMockChannel = (overrides = {}) => {
  mockIdCounter++;
  return {
    id: { channelId: `UCTest${mockIdCounter}` },
    snippet: {
      title: `Test Gaming Channel ${mockIdCounter}`,
      description: `A test gaming channel ${mockIdCounter}`,
      publishedAt: '2020-01-01T00:00:00Z',
      thumbnails: {
        default: { url: `https://example.com/thumb${mockIdCounter}.jpg` }
      }
    },
    statistics: {
...
const createMockVideo = (overrides = {}) => {
  mockIdCounter++;
  return {
    id: { videoId: `test-video-id-${mockIdCounter}` },
    snippet: {
      title: `Test Gaming Video ${mockIdCounter}`,
      description: `A test gaming video ${mockIdCounter}`,
...
describe('Channels Routes (Working)', () => {
  let app;
